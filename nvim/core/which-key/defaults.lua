return {
    ...
    u = {
        name = "UI",
        c = { "<cmd>lua require('core.utils').toggle_set_color_column()<CR>", "Toggle Color Line" },
        l = { "<cmd>lua require('core.utils').toggle_cursor_line()<CR>", "Toggle Cursor Line" },
        b = { "<cmd>lua require('core.utils').change_background()<CR>", "Toggle Background" },
    },
    i = {
        name = "Sessions",
