...
# Node
let FNM_MULTISHELL_PATH = (fnm env --shell bash | lines | where {|l| $l starts-with "export "} | parse "export {key}={value}" | update value {|r| $r.value | str trim --char '"'} | transpose -r | into record | get FNM_MULTISHELL_PATH)
